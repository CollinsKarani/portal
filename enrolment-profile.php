         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu active">
                  ...
                  <ul class="sub">
                  <li class="active"><a class="" href="enrolment-profile">Enrolment Profile</a></li>
                 ...
                 <div class=" profile span12">
                     <div class="span2">
                         <div class="profile-photo">
                         	<?php if($update['Photo'] != ""): ?>
                         	<img src="students/<?php echo $update['Photo']; ?>">
                                	<?php else: ?>
                                    <img src="images/noimage.png" alt="Profile Picture" />
                                      	<?php endif; ?>
                             <a href="javascript:;" class="edit" title="Edit Photo">
                                 <i class="icon-pencil"></i>
                             </a>
                         </div>
                         <a href="enrolment-profile" class="profile-features active">
                             <i class=" icon-home"></i>
                             <p class="info">Main Details</p>
                         </a>
                         <a href="parent-record-info" class="profile-features ">
                             <i class=" icon-male"></i>
                     ...
                     <div class="span10">
                         ...
                         <div class="widget red">
                          <div class="widget-title">
                                <h4><i class="icon-home"></i>Main Admission Details</h4>
                            <span class="tools">
                             ...
                             <div class="span6 bio">
                                 <h3>Personal</h3>
                                 <hr>
                                 <p><label>Full Name </label>: <strong><?php echo  $update['FullName'] ?></strong></p>
                                  <p><label>Admission No </label>:<strong> <?php echo $update['AdmNo'] ?></strong></p>
                                 <p><label>Country </label>:<strong> Kenya</strong></p>
                                 <p><label>Date of Birth </label>:<strong><?php echo $update['dob']; ?></strong></p>
                                 <p><label>Email </label>: <strong><?php echo $update['studeEmail']; ?></strong></p>
                                 <p><label>Phone Number</label>:<strong><?php echo $update['studeMobile'];?></strong></p>
                             ...
                             <h3>Information</h3>
                               ...
                               <div class="row-fluid">
                             <div class="span6 bio">
                                <p><label>K.C.P.E Marks </label>: <strong><?php echo  $update['PriSchMarks']; ?></strong></p>
                                 <p><label>Phone Number </label>: <strong><?php echo  $update['Phone']; ?></strong></p>
                                  <p><label>Religion </label>:<strong> <?php  echo $update['studeReligion']; ?></strong></p>
                                 <p><label>Address </label>:<strong> <?php echo $update['studeAddress']; ?></strong></p>
                                  <p><label>County </label>:<strong> <?php  echo $update['studeCounty']; ?></strong></p>
                                 <p><label>Sub-County </label>: <strong><?php echo $update['studeSubCounty']; ?></strong></p>
