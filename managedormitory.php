                  ...
                  <div class="span12">
                    <div class="widget purple">
                        <div class="widget-title">
                            <h4><i class="icon-home"></i> AVAILABLE DORMITORIES</h4>
                                   <span class="tools">
                        ...
                        <div class="widget-body form">
                            ...
                            <tbody>
                            <?php
                              $result = $conn ->prepare("SELECT * FROM tblhouse");
                              $result ->execute();
                              	while($dorm=$result->fetch(PDO::FETCH_ASSOC))
		                           {
		                 	?>
			             <tr>
			           <td><?php echo $dorm['HouseName']; ?></td>
                          <td><?php echo $dorm['Capacity']; ?></td>
                          <td><?php echo $dorm['Occupied']; ?></td>
                          <td><?php echo $dorm['HouseMaster']; ?></td>
                          <td><?php echo $dorm['HousePrefect']; ?></td>
                          <td><?php echo $dorm['HouseCaptain']; ?></td>
