          ...
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu active">
                  ...
                  <li><a class="" href="enrolment-profile">Enrolment Profile</a></li>
                   <li class="active"><a class="" href="update-profile-to-upto-date">Update Admission info</a></li>
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      ...
                      <li><a class="" href="available-assignment.php">My Assignment</a></li>
                  </ul>
              </li>
             <li class="sub-menu">
      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
                 ...
                 <div class=" profile span12">
                     ...
                     <div class="span10">
                         <div class="profile-head">
                             <div class="span4">
                                 <h1><?php echo  $update['FullName']; ?></h1>
            ...
            if((isset($_POST['btn-update'])))
                ...
                $number = ($_POST['AdmNo']);
                $dobirth = ($_POST['dob']);
                $address=($_POST['studeAddress']);
                $religion=($_POST['studeReligion']);
                $email=($_POST['studeEmail']);
                $county=($_POST['studeCounty']);
                $sub=($_POST['studeSubCounty']);
                $phone=($_POST['studeMobile']);
                    try
                	{

//$stmt = $conn->prepare("UPDATE tblupdate SET AdmNo=:adm dob=:birth,studeAddress=:Saddress,studeReligion=:relig,studeEmail=:Semail',studeCounty=:county1,studeSubCounty=:sub1,studeMobile=:phone1 WHERE AdmNo=:numb");
    $stmt =$conn->prepare("UPDATE tblupdate SET dob='$dobirth',studeAddress='$address',studeReligion='$religion',studeEmail='$email',studeCounty='$county',studeSubCounty='$sub',studeMobile='$phone' WHERE AdmNo='$session_id'");
...
?>
                                 <form class="form-horizontal" style="padding-left: 15px;" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" autocomplete="off" enctype="multipart/form-data">
                                      <div class="control-group">
                                         ...
                                         <div class="controls">
                                             <input type="text" class="span6 " name="AdmNo" value="<?php echo $update['AdmNo']; ?>" readonly="readonly">
                                         </div>
                                     </div>
                                     <div class="control-group">
                                         <label class="control-label">Full Name:</label>
                                         <div class="controls">
                                             <input type="text" class="span6 " name="FullName" value="<?php echo $update['FullName']; ?>" readonly="readonly">
                                         </div>
                                     </div>
                                 <div class="control-group">
