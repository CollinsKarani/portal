          ...
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="assignment">My Assignment</a></li>
                  </ul>
              </li>
             <li class="sub-menu">
                  ...
                  <li class="tooltip" data-placement="right" data-original-title="Reporting Dates"><a href="#"><i class="icon-signin"></i> <span class="title">Reporting Dates</span></a></li>
                  ...
                  <div class="span12">
                    <div class="widget red">
                        <div class="widget-title">
                            <h4><i class="icon-download"></i> AVAILABLE ASSIGNMENTS</h4>
                                   <span class="tools">
                        ...
                        <div class="widget-body form">
                            ...
                            <tbody>
                                <?php
                                 $sql = $conn ->prepare("SELECT * FROM tblresource");
                                 $sql ->execute();
                                 ...
                                 <tr>
                                  ...
                                  <td><?php echo $row['Description']; ?></td>
                                   ...
                                   <td><a href="uploads/<?php echo $row['file']; ?>" target="_blank"><button class="btn btn-small btn-primary"><i class="icon-download icon-white"></i> Download</button></a></td>
                                 </tr>
                                  <?php
                                 }
